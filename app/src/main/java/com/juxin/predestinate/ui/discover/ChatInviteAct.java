 ...
 */
public class ChatInviteAct extends BaseActivity implements AdapterView.OnItemClickListener, XListView.IXListViewListener,
        SwipeListView.OnSwipeItemClickedListener, AbsListView.OnScrollListener, View.OnClickListener, PObserver {

    private CustomFrameLayout customFrameLayout;
    private SwipeListView exListView;

    private ChatInviteAdapter adapter;
    ...
    private void initView() {
        ...
        adapter = new ChatInviteAdapter(this, null);
    ...
    private void initData() {
        adapter.setListNonotify(ModuleMgr.getChatListMgr().getInviteList());
        PLogger.d("initData=" + ModuleMgr.getChatListMgr().getInviteList().size());
            ...
            case R.id.chatinviteact_bottom_all_ignore:
                ...
                PickerDialogUtil.showSimpleAlertDialog(this, new SimpleTipDialog.ConfirmListener() {
                    ...
                    public void onSubmit() {
                        onHidTitleLeft();
                        LoadingDialog.show(ChatInviteAct.this, "忽略中...");
                        ModuleMgr.getChatListMgr().updateToBatchRead(ModuleMgr.getChatListMgr().getInviteList(), new DBCallback() {
                            @Override
                            public void OnDBExecuted(long result) {
