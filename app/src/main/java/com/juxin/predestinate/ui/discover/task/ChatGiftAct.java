...
import com.juxin.predestinate.ui.discover.ChatPageAdapter;
 ...
 */
public class ChatGiftAct extends BaseActivity implements AdapterView.OnItemClickListener,
    ...
    private void initView() {
        setTitle(getString(R.string.chat_gift_title));
        setBackView();
    ...
    private void initData() {
        adapter.setListNonotify(ModuleMgr.getChatListMgr().getGiftList());
        PLogger.d("initData=" + ModuleMgr.getChatListMgr().getGiftList().size());
            ...
            case R.id.chatinviteact_bottom_all_ignore:
                ...
                PickerDialogUtil.showSimpleAlertDialog(this, new SimpleTipDialog.ConfirmListener() {
                    ...
                    public void onSubmit() {
                        onHidTitleLeft();
                        LoadingDialog.show(ChatGiftAct.this, "忽略中...");
                        ModuleMgr.getChatListMgr().updateToBatchRead(ModuleMgr.getChatListMgr().getGiftList(), new DBCallback() {
                            @Override
                            public void OnDBExecuted(long result) {
