 ...
 */
public class LevelOfIntimacyPanel extends BasePanel implements RequestComplete, ExListView.IXListViewListener {
    ...
    public LevelOfIntimacyPanel(Context context) {
        super(context);
        mContext = context;
