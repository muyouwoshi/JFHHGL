 ...
 */
public class ChatStrangerAct extends BaseActivity implements AdapterView.OnItemClickListener,
    ...
    private void initView() {
        setTitle(getString(R.string.chat_stranger_title));
        setBackView();
        ...
        adapter = new ChatPageAdapter(this, null, ChatPageAdapter.CHAT_STRANGER_PAGE);
    ...
    private void initData() {
        adapter.setListNonotify(ModuleMgr.getChatListMgr().getStrangerList());
        PLogger.d("initData=" + ModuleMgr.getChatListMgr().getStrangerList().size());
            ...
            case R.id.chatinviteact_bottom_all_ignore:
                ...
                PickerDialogUtil.showSimpleAlertDialog(this, new SimpleTipDialog.ConfirmListener() {
                    ...
                    public void onSubmit() {
                        onHidTitleLeft();
                        LoadingDialog.show(ChatStrangerAct.this, "忽略中...");
                        ModuleMgr.getChatListMgr().updateToBatchRead(ModuleMgr.getChatListMgr().getStrangerList(), new DBCallback() {
                            @Override
                            public void OnDBExecuted(long result) {
