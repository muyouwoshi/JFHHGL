...
/**
 * retrofit+rxjava2使用的文件下载回调处理，实现内容与{@link FileObserver}保持一致
 *
 * @author ZRP
 * @date 2017/11/7
 */
public class FileConsumer implements Consumer<Response<ResponseBody>> {
    ...
    public FileConsumer(String url, String filePath, DownloadListener listener) {
        this.url = url;
    ...
    @Override
    public void accept(final Response<ResponseBody> response) throws Exception {
