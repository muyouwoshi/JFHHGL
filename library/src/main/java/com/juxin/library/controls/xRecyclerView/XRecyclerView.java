...
public class XRecyclerView extends RecyclerView {
    ...
    public void setArrowTextView(String header_refreshing) {
        if (mRefreshHeader != null) {
            mRefreshHeader.setArrowTextView(null, header_refreshing, null);
        }
    }

    public void setArrowTextView(String header_hint_normal, String header_refreshing, String header_refresh_done) {
        if (mRefreshHeader != null) {
            mRefreshHeader.setArrowTextView(header_hint_normal, header_refreshing, header_refresh_done);
        }
    }
